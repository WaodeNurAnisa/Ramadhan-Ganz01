...
/////////////////
const BotName = 'Rama Bot'; 
const instagram = 'https://instagram.com/qoutes_biak_comuniti'; 
const telegram = 'https://wa.me/6282239750866'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Rama ID';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@qoutes_biak_comuniti')
